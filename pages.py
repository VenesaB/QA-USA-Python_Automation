...
from selenium.webdriver.support.wait WebDriverWait
...
class UrbanRoutesPage:
    ...
    CALL_TAXI_LOCATOR = (By.XPATH, '<button type="button" class="button round">Call a taxi</button>')
...
def enter_from_location(self, from_text):
     self.driver.find_element(*self.FROM_LOCATOR).get_attribute("value")
...
def get_to(self):
    return
self.driver.find_element(*self.TO_LOCATION).get_attribute("value")
